...
<xsl:template name="top">
	<div id="summercamp">
		...
		<div class="introduction">
			<h2 class="header"><a href="{$root}/about">Summer Camp 2011</a></h2>
			<p>
				Come join us for Summer camp, <!--<strong><em>&#8220;Rocking and Flippin!&#8221;</em></strong>--> There will be gymnastics, games, field trips, karate, movies, talent shows, ice cream parties and much much more! Camp starts on June 6th and goes through August 5th. A schedule of activities is below. To signup, or for further questions, <a href="{$root}/contact">contact us</a>.
			</p>
		</div>
		<div>
...
<xsl:template match="data">
	...
	<li>Half day - 3 yrs. old and up</li>
	<li>Full day - 5 yrs. old and up</li>
	...
	<tr><td>five</td><td>$120</td><td>five</td><td>$210</td></tr>
	</tbody></table>
	</div>
	<div id="right">
	<h4><strong>Activities include:</strong></h4><a href="{$workspace}/files/Summer-Calender-2011.pdf"><div style="float: right; width: 150px;"><img src="{$workspace}/images/summer-camp-thumbnail.PNG" style=" height: auto; width: 150px" /><br /><strong>Summer Camp Schedule (PDF)</strong></div></a><ul>
	...
	<li>A complete list <a href="{$workspace}/files/Summer-Calender-2011.pdf">can be found here</a>. This is a <a href="http://get.adobe.com/reader/">PDF file</a>, for which you need <a href="http://get.adobe.com/reader/">Adobe Acrobat</a>, and you can get that <a href="http://get.adobe.com/reader/">here!</a></li>
